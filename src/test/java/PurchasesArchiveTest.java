...
public class PurchasesArchiveTest {
    ...
    public void printItemPurchaseStatisticsOneItemTest() {
        ...
        // ARRANGE
        // test only printItemPurchaseStatistics
        Mockito.when(mockedItemPurchaseArchiveEntry.toString()).thenReturn("something");
        itemArchive.put(1, mockedItemPurchaseArchiveEntry);
        PurchasesArchive purchasesArchive = new PurchasesArchive(itemArchive, null);
        String expected = "ITEM PURCHASE STATISTICS:" + System.lineSeparator() + "something" + System.lineSeparator();
