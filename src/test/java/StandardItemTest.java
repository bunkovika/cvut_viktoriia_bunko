...
public class StandardItemTest {
    ...
    @BeforeEach
    public void setup() {
        standardItem = new StandardItem(1, "Test item", (float) 18.9, "Test category", 10);
    }
    ...
    public void constructorTest() {
        ...
        float expectedPrice = (float) 18.9;
    ...
    private static Stream<Arguments> generator() {
        return Stream.of(
                Arguments.of(
                        new StandardItem(1, "Test name", (float) 18.9, "Test category", 10),
                        new StandardItem(1, "Test name", (float) 18.9, "Test category", 10),
                        true
                ),
//                bad id
                Arguments.of(
                        new StandardItem(1, "Test name", (float) 18.9, "Test category", 10),
                        new StandardItem(2, "Test name", (float) 18.9, "Test category", 10),
                        false
                ),
//                bad name
                Arguments.of(
                        new StandardItem(1, "Test name", (float) 18.9, "Test category", 10),
                        new StandardItem(1, "Test", (float) 18.9, "Test category", 10),
                        false
                ),
//                bad float number
                Arguments.of(
...
//                bad category
                Arguments.of(
                        new StandardItem(1, "Test name", (float) 18.9, "Test category", 10),
                        new StandardItem(1, "Test name", (float) 18.9, "Test", 10),
                        false
                ),
//                bad loyaltyPoints
                Arguments.of(
                        new StandardItem(1, "Test name", (float) 18.9, "Test category", 10),
                        new StandardItem(1, "Test name", (float) 18.9, "Test category", 37),
                        false
                )
        );
    }
